                    ...
                    <div class="arlo_tm_portfolio_single_wrap">
                        <div class="container">
                            <div class="arlo_tm_title_holder">
                                <h3>Description</h3>
                                <span>Ici vous pouvez modifier votre description.</span>
                            </div>
                            ...
                            <div class="col-xl">
                                <div class="card">
                                    <div class="card-header">
                                        Modifier la <strong>description</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="dscptChange.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="texte" class=" form-control-label">Description actuelle :</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <?php
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="texte" class=" form-control-label">Nouvelle description :</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <textarea name="texte" id="textarea-input" rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
